...
# ./deploy-xmas.sh northeurope 7d5e75b2-356e-4bf6-b12f-24e2e79a8269
...
echo "This script will create XMas environment in $location"

TERRAFORM_STORAGE_NAME="tfxmas${location}"
TERRAFORM_STATE_RESOURCE_GROUP_NAME="xmas${location}_tfstate_rg"
